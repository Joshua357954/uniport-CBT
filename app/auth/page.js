...
function Auth() {
  ...
  const signInWithGoogle = () => {
    ...
    if (department === "" || level === "") {
      toast.error("Please select a department / Level");
      return;
    }
    ...
    signInWithPopup(auth, provider)
      .then(async (result) => {
        ...
        let url =
          "https://api.sheety.co/766cbc7853811a71e0a5dd0daf78e2e8/quizlerUsers/sheet1";
        let body = {
          sheet1: {
      ...
      <header className="w-full mb-3">
        ...
        <div className="h-80 w-full flex  items-center ">
          <div className="px-5 md:text-center w-full">
            <p className="text-4xl font-black text-green-950 mb-2 leading-tight md:text-center">
              Embark on a Journey of Knowledge
            </p>

            <p className="text-base font-medium mt-3 mb-5 leading-loose text-gray-600 md:text-center">
              Let success be your guiding star as you explore our{" "}
            ...
            <small className="mt-2 text-center">
              <a
                href="#"
                className="px-3 py-2 mt-2 mb-1 rounded-xl  bg-green-100 text-sm text-green-700 hover:underline"
              >
                {" "}
                ➖&nbsp;&nbsp;
                <b className="">C.Sc Help Group (Built by Joshua Boyi)</b>
              </a>
            </small>
          </div>
        </div>
        ...
        <div className="bg-white w-[90%] sm:w-1/2 h-1/2 xl:1/3 drop-shadow-lg rounded-md flex flex-col items-center justify-between py-8 sm:py-5 px-4 border-t-2 border-gray-200">
          ...
          <div className="w-full flex flex-col justify-center items-center my-4">
            <div className="bg-gray-100  w-5/6 flex justify-between mb-6 py-3 px-2 rounded-lg items-center">
              ...
              <select
                className="outline-none focus:outline-none h-full bg-transparent mySelect capitalize"
                onChange={handleDepartmentChange}
              >
                <option value="">Select Department</option>
                {Object.keys(courseShortForms).map((course) => (
                  <option key={course} value={course} className="capitalize">
                    {course}
                  </option>
                ))}
              </select>
          ...
          <button
            ...
            className="bg-green-600 text-white w-5/6 py-3 font-semibold rounded-lg"
          >
            SignIn
          </button>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-between mb-8">
            <div className="w-full sm:w-auto mb-4 sm:mb-0">
              ...
              <p className="text-sm">
                We are passionate about education and strive to make learning
                fun and engaging through our cbt practice app .
              </p>
            </div>
              ...
              <ul className="text-sm pt-1">
                <li className="flex mt-2 items-center mb-3">
                  ...
                  <a
                    ...
                    className="text-green-100 font-semibold no-underline hover:underline"
                  >
                    Chat us on WhatsApp
                  </a>
                </li>
                ...
                <li className="flex mt-4 items-center ">
                  ...
                  <a
                    href="mailto:csfun100@gmail.com"
                    className="text-green-100 font-semibold no-underline hover:underline"
                  >
                    Send us a mail
                  </a>
          ...
          <div className="my-8">
            ...
            <ul className="text-sm mt-3 flex flex-col gap-2">
              <li className="px-2 py-1 rounded-xl bg-green-900 w-fit">
                <strong className="text-green-100">Joshua Boyi</strong> - Lead
                Developer
              </li>

              <li className="px-2 py-1 mt-2 rounded-xl bg-green-900 w-fit">
                <strong className="text-green-100">Chisom Joseph</strong> -
                Frontend Designer
              </li>
            </ul>
          </div>
          ...
          <div className="my-14 text-sm flex flex-col gap-y-3">
            <p>
              Powered by :{" "}
              <strong className="text-green-100">CSC HELP Group</strong> ⚡
            </p>
            <p className="text-green-50">Courtesy of CSC Year 3 🎓</p>
          </div>
          <div className="border-t border-gray-100 pt-4 text-sm text-center">
            <p>&copy; 2025 Cbt Box. All rights reserved.</p>
          </div>
        </div>
      </footer>
      <Toaster />
